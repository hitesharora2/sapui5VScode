sap.ui.define([
	...
	return Opa5.extend("com.wfp.DemoSAPui5.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/wfp/DemoSAPui5/localService/mockserver"], function (mockserver) {
